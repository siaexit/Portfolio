  ...
  const experiences = [
    {
      ...
      period: '2023年 — 現在',
      description:
        'エンタープライズSaaS製品のフロントエンド開発をリード。スケーラブルなReactアプリケーションの設計とチームメンバーのメンタリング。',
    },
    {
      title: 'UI/UXデザイナー＆フロントエンド開発者',
    ...
    {
      title: 'ジュニアフロントエンド開発者',
      company: 'スタートアップ株式会社',
      period: '2019年 — 2021年',
      description:
        'Reactとモダンなweb技術を使用してユーザーインターフェースを構築。デザイナーやバックエンドエンジニアと協力。',
    },
  ];
